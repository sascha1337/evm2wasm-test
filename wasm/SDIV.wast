(func $SDIV
  ...
  (local.set $sign (i32.wrap/i64 (i64.shr_u (i64.xor (local.get $a1) (local.get $a)) (i64.const 63))))
      ...
      (loop $loop
        ...
        (if (call $gte_256 (local.get $a) (local.get $b) (local.get $c) (local.get $d) (local.get $a1) (local.get $b1) (local.get $c1) (local.get $d1))
          (then
            ...
            (local.set $temp  (i64.add  (local.get $cq) (i64.extend_u/i32 (local.get $carry))))
            ...
            (local.set $temp  (i64.add  (local.get $bq) (i64.extend_u/i32 (local.get $carry))))
            ...
            (local.set $aq    (i64.add  (local.get $maska) (i64.add (local.get $aq) (i64.extend_u/i32 (local.get $carry)))))
          )
        )
        ;; divisor = divisor >> 1
  ...
  (if (local.get $sign)
    (then
      ...
      (local.set $cq (i64.add (local.get $cq) (i64.extend_u/i32 (i64.eqz (local.get $dq)))))
      (local.set $bq (i64.add (local.get $bq) (i64.extend_u/i32 (i64.eqz (local.get $cq)))))
      (local.set $aq (i64.add (local.get $aq) (i64.extend_u/i32 (i64.eqz (local.get $bq)))))
    )
  )
